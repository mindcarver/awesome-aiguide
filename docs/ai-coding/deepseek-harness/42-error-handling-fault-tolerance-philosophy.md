...
![七条容错规则的出身](imgs/42-01-seven-rules-origin.png)
...
![正交结果独立报告](imgs/42-02-orthogonal-results.png)
...
![双侧公共契约](imgs/42-03-dual-contract.png)
...
![异步状态的时间边界](imgs/42-04-async-state.png)
...
![销毁到达平静的阶梯](imgs/42-05-quiescent-disposal.png)
...
![dispatcher 隔离回调异常](imgs/42-06-dispatcher-isolation.png)
...
![清洗环境与私有随机路径](imgs/42-07-clean-env-private-path.png)
...
![链接形路径只 unlink](imgs/42-08-unlink-links.png)
...
![结构化错误分类学](imgs/42-09-structured-error-taxonomy.png)

![完整 cause 链的诊断价值](imgs/42-10-cause-chain-diagnostics.png)
...
![request-error 动态恢复](imgs/42-11-request-error-retry.png)
...
![Landlock 错误误分类](imgs/42-12-landlock-misclassification.png)
...
![178 个绿灯仍然生产全崩](imgs/42-13-178-green-lights.png)
...
![测试真实入口并验证世界](imgs/42-14-test-real-entry.png)
...
![容错的成本与天花板](imgs/42-15-cost-and-ceiling.png)
...
![错误处理与容错总结](imgs/42-16-fault-tolerance-summary.png)
