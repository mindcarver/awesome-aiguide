...
本篇建立一个完整的行业拆解方法论，用系统化的方法拆解一个行业，理解它的价值链、商业模式、核心流程和关键痛点，然后从中发现AI可以真正落地创造价值的机会。很多AI项目之所以失败，不是因为技术不行，而是因为做项目的人根本不理解那个行业，不知道真正的痛点在哪里，不知道数据在哪里，不知道谁会为这个东西买单。

内容分为三部分：先建立方法论框架，然后用这个方法拆解三个典型行业——半导体、制造业和金融投研。半导体是典型的高技术高资本行业，制造业是AI落地场景最丰富的行业之一，金融投研则是信息密度最高、对决策质量要求最苛刻的行业。
