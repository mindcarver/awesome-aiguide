...
type: flowchart
style: notion
article: "Codex App 能力边界图：Browser、Computer Use、PR Chat、Sites 与可视化"
position: "Browser：网页任务的窄入口"
---
...
- Browser：网页任务的窄入口
- requirements.toml
- 内置 Browser 使用独立于日常浏览器的 profile，不会自动共享现有 tab 和登录会话
- 需要账号时可以在该 profile 登录
