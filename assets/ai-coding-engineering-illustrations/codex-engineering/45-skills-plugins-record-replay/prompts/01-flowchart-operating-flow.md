...
type: flowchart
style: notion
article: "Codex Skills、Plugins 与 Record & Replay：能力怎么制作、分发和授权"
position: "TL;DR"
---
...
- TL;DR
- Skill 是可复用工作流的作者格式，Plugin 是把 Skills、MCP Servers、连接器和 Hooks 打包分发的容器，Record & Replay 是在 macOS 上把一次可观察操作转成 Skill 草稿的制作方式
- 三者位于不同层，不能互相替代
